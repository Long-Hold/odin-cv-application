...
export const sampleResumeData = {
  ...
  [RESUME_KEYS.WORK_EXPERIENCE]: [
    ...
    },
    {
      ...
      [WORK_EXPERIENCE_KEYS.JOB_DESCRIPTION]: `I build front-end websites on short-term contracts; handling everything from UIs and API integrations to hosting.
    ...
    },
    {
      ...
      [WORK_EXPERIENCE_KEYS.JOB_DESCRIPTION]: `I was responsible for creating and editing designs that we would use for our vinyl wraps, stickers, and decals in Adobe Illustrator and Photoshop.
